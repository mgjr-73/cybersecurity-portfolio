...
- ## Cookie Jar
    ...
    - Inspecting the html, I saw a comment about session handling being on the client side only. It was using client-side `role` cookie. "clerk" was encoded in base64.  
